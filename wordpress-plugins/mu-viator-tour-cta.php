<?php
/**
 * Plugin Name: Viator Tour CTA (MU)
 * Description: Adds Viator affiliate tour links to posts - Must Use Plugin
 * Version: 1.0.0
 * Author: Cursed Tours
 * 
 * INSTALLATION: Upload to wp-content/mu-plugins/mu-viator-tour-cta.php
 * Auto-activates, no activation required.
 */
