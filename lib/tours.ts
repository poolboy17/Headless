...
export const cities: City[] = [
  ...
  { 
    ...
    country: 'Romania', 
    viatorDest: 'd22413',
    description: 'Home of Dracula\'s Castle, where Gothic legends and dark history create the ultimate vampire experience.',
    imageUrl: optimizedUnsplash('photo-1580394693539-2eb89614e3f5', 800, 600),
    iconPath: 'transylvania'
  },
];
...
export const tours: Tour[] = [
  ...
  {
    id: '22',
    title: 'Dracula\'s Castle Day Trip from Bucharest',
    cityId: 'transylvania',
    type: 'bus',
    price: '$45',
    rating: 4.7,
    ...
    duration: '12 hours',
    groupSize: 'Small group',
    imageUrl: optimizedUnsplash('photo-1580394693539-2eb89614e3f5'),
    viatorUrl: buildViatorSearchUrl('22413', 'dracula castle bran day trip bucharest'),
    description: 'Visit the legendary Bran Castle, explore medieval Transylvania, and discover the real history behind Dracula.',
  },
  {
    id: '23',
    title: 'Transylvania Dracula Tour with Castle Visit',
    cityId: 'transylvania',
    type: 'bus',
    price: '$65',
    rating: 4.8,
    ...
    groupSize: 'Small group',
    imageUrl: optimizedUnsplash('photo-1580394693539-2eb89614e3f5'),
    viatorUrl: buildViatorSearchUrl('22413', 'transylvania dracula tour castle peles'),
    description: 'Full-day journey through Transylvania including Bran Castle, Peles Castle, and the medieval town of Brașov.',
  },
  {
    id: '24',
    title: 'Halloween at Dracula\'s Castle Party',
    cityId: 'transylvania',
    type: 'night',
    price: '$150',
    rating: 4.9,
    ...
    imageUrl: optimizedUnsplash('photo-1580394693539-2eb89614e3f5'),
    viatorUrl: buildViatorSearchUrl('22413', 'halloween party dracula castle bran'),
    description: 'Exclusive Halloween night party inside Bran Castle with costumes, entertainment, and spooky atmosphere.',
  },
  {
    id: '25',
    title: 'Vlad the Impaler History Tour',
    cityId: 'transylvania',
    type: 'walking',
    price: '$35',
    rating: 4.6,
    ...
    groupSize: 'Small group',
    imageUrl: optimizedUnsplash('photo-1580394693539-2eb89614e3f5'),
    viatorUrl: buildViatorSearchUrl('22413', 'vlad impaler history tour transylvania'),
    description: 'Discover the true story of Vlad III, the brutal ruler who inspired Bram Stoker\'s Dracula.',
  },
];
