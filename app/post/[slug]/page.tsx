...
const INLINE_IMAGES: Record<string, Array<{ url: string; alt: string }>> = {
  'abandoned-asylums-hospitals': [
    ...
    { url: '/assets/fallbacks/abandoned_hospital_eerie_hallway.png', alt: 'Dark abandoned psychiatric hospital hallway with flickering lights' },
    { url: '/assets/fallbacks/victorian_asylum_exterior_night.png', alt: 'Crumbling Victorian asylum exterior at night with full moon' },
    { url: '/assets/fallbacks/abandoned_hospital_operating_room.png', alt: 'Abandoned operating room with rusted surgical equipment' },
    { url: '/assets/fallbacks/mental_institution_dark_corridor.png', alt: 'Long dark corridor in abandoned mental institution' },
    { url: '/assets/fallbacks/victorian_psychiatric_ward_beds.png', alt: 'Victorian psychiatric ward with old hospital beds' },
    { url: '/assets/fallbacks/abandoned_orphanage_dormitory_beds.png', alt: 'Abandoned orphanage dormitory with rows of old beds' },
    { url: '/assets/fallbacks/abandoned_sanatorium_rooftop_garden.png', alt: 'Abandoned sanatorium rooftop garden overtaken by nature' },
    { url: '/assets/fallbacks/psychiatric_hospital_lobby_abandoned.png', alt: 'Abandoned psychiatric hospital lobby with debris' },
    { url: '/assets/fallbacks/abandoned_morgue_metal_tables.png', alt: 'Abandoned morgue with metal examination tables' },
  ],
  'haunted-castles-estates': [
    ...
    { url: '/assets/fallbacks/gothic_castle_midnight_storm.png', alt: 'Ancient Gothic castle on cliff during lightning storm' },
    { url: '/assets/fallbacks/haunted_mansion_grand_staircase.png', alt: 'Haunted Victorian mansion grand staircase with supernatural mist' },
    { url: '/assets/fallbacks/haunted_victorian_mansion_night.png', alt: 'Haunted Victorian mansion at night with eerie glow' },
    { url: '/assets/fallbacks/victorian_seance_room.png', alt: 'Victorian seance room with mysterious atmosphere' },
    { url: '/assets/fallbacks/spiral_staircase_dark_mansion.png', alt: 'Spiral staircase in dark Victorian mansion' },
    { url: '/assets/fallbacks/victorian_attic_dusty_cobwebs.png', alt: 'Victorian attic filled with dusty furniture and cobwebs' },
    { url: '/assets/fallbacks/abandoned_ballroom_grand_piano.png', alt: 'Abandoned ballroom with grand piano covered in dust' },
    { url: '/assets/fallbacks/haunted_mansion_garden_maze.png', alt: 'Haunted mansion garden maze shrouded in fog' },
    { url: '/assets/fallbacks/crumbling_tower_spiral_staircase.png', alt: 'Crumbling tower with spiral staircase and supernatural light' },
    { url: '/assets/fallbacks/grandfather_clock_dark_hallway.png', alt: 'Grandfather clock in dark hallway casting eerie shadows' },
    { url: '/assets/fallbacks/victorian_supernatural_mirror_reflection.png', alt: 'Victorian mirror showing supernatural reflection' },
    { url: '/assets/fallbacks/creepy_victorian_nursery_room.png', alt: 'Creepy Victorian nursery room with old toys' },
  ],
  'ghost-hunting-techniques-tools': [
    ...
    { url: '/assets/fallbacks/ghost_hunting_equipment_table.png', alt: 'Ghost hunting equipment laid out on table' },
    { url: '/assets/fallbacks/investigator_silhouette_flashlight.png', alt: 'Paranormal investigator silhouette with flashlight in dark building' },
    { url: '/assets/fallbacks/evp_recording_séance_setup.png', alt: 'EVP recording session setup with vintage equipment' },
    { url: '/assets/fallbacks/thermal_imaging_paranormal_view.png', alt: 'Thermal imaging camera view showing paranormal cold spots' },
    { url: '/assets/fallbacks/evp_spirit_communication_equipment.png', alt: 'EVP spirit communication equipment setup' },
    { url: '/assets/fallbacks/seance_table_ouija_crystal.png', alt: 'Seance table with ouija board and crystal ball' },
    { url: '/assets/fallbacks/old_photograph_darkroom_red.png', alt: 'Old photograph darkroom with red lighting' },
  ],
  'historical-hauntings-insights': [
    { url: '/assets/fallbacks/historical_haunting_victorian_sepia.png', alt: 'Historical Victorian era haunting scene in sepia tones' },
    { url: '/assets/fallbacks/victorian_séance_room_crystal.png', alt: 'Old Victorian seance room with crystal ball and candles' },
    { url: '/assets/fallbacks/abandoned_church_gothic_interior.png', alt: 'Abandoned church interior with shattered stained glass' },
    { url: '/assets/fallbacks/underground_crypt_stone_tombs.png', alt: 'Underground crypt with ancient stone tombs and flickering torches' },
    { url: '/assets/fallbacks/ancient_catacombs_skull_walls.png', alt: 'Ancient catacombs with skull-lined walls' },
    { url: '/assets/fallbacks/abandoned_chapel_candlelight_shadows.png', alt: 'Abandoned chapel with candlelight casting shadows' },
    { url: '/assets/fallbacks/ancient_burial_ground_ravens.png', alt: 'Ancient burial ground with ravens perched on stones' },
    { url: '/assets/fallbacks/foggy_moor_standing_stones.png', alt: 'Foggy moor with ancient standing stones' },
    { url: '/assets/fallbacks/old_apothecary_mysterious_potions.png', alt: 'Old apothecary shop with mysterious potions and bottles' },
  ],
  'urban-exploration-paranormal': [
    { url: '/assets/fallbacks/abandoned_industrial_urban_exploration.png', alt: 'Abandoned industrial building for urban exploration' },
    { url: '/assets/fallbacks/haunted_hotel_corridor_vintage.png', alt: 'Haunted hotel corridor with vintage wallpaper and flickering lights' },
    { url: '/assets/fallbacks/creepy_doll_room_abandoned.png', alt: 'Creepy doll room in abandoned house with vintage dolls' },
    { url: '/assets/fallbacks/abandoned_haunted_theater_stage.png', alt: 'Abandoned haunted theater with empty stage' },
    { url: '/assets/fallbacks/abandoned_train_station_fog.png', alt: 'Abandoned train station shrouded in fog' },
    { url: '/assets/fallbacks/abandoned_prison_cell_block.png', alt: 'Abandoned prison cell block with rusted bars' },
    { url: '/assets/fallbacks/abandoned_carnival_night_horror.png', alt: 'Abandoned carnival at night with horror atmosphere' },
    { url: '/assets/fallbacks/abandoned_schoolhouse_eerie_interior.png', alt: 'Abandoned schoolhouse with eerie interior' },
    { url: '/assets/fallbacks/abandoned_mine_shaft_entrance.png', alt: 'Abandoned mine shaft entrance in darkness' },
    { url: '/assets/fallbacks/abandoned_victorian_greenhouse_fog.png', alt: 'Abandoned Victorian greenhouse filled with fog' },
    { url: '/assets/fallbacks/old_wine_cellar_cobwebs.png', alt: 'Old wine cellar with dusty bottles and cobwebs' },
    { url: '/assets/fallbacks/haunted_old_library_supernatural.png', alt: 'Haunted old library with supernatural presence' },
  ],
  'default': [
    ...
    { url: '/assets/fallbacks/dark_forest_supernatural_path.png', alt: 'Dark forest path at night with twisted trees and supernatural mist' },
    { url: '/assets/fallbacks/haunted_lighthouse_storm_night.png', alt: 'Abandoned lighthouse on rocky shore during night storm' },
    { url: '/assets/fallbacks/misty_graveyard_midnight_fog.png', alt: 'Misty graveyard at midnight with fog rolling between graves' },
    { url: '/assets/fallbacks/stormy_abandoned_lighthouse.png', alt: 'Stormy abandoned lighthouse with dramatic atmosphere' },
    { url: '/assets/fallbacks/haunted_forest_path.png', alt: 'Haunted forest path with eerie supernatural presence' },
    { url: '/assets/fallbacks/mysterious_shrine_in_fog.png', alt: 'Mysterious shrine shrouded in supernatural fog' },
    { url: '/assets/fallbacks/supernatural_glowing_well_forest.png', alt: 'Supernatural glowing well in dark forest' },
    { url: '/assets/fallbacks/haunted_covered_bridge_fog.png', alt: 'Haunted covered bridge shrouded in fog' },
  ],
};
