...
export default async function CityToursPage({ params, searchParams }: CityPageProps) {
  ...
  const { tours, totalTours, totalPages, currentPage } = getToursByCity(cityId, requestedPage, toursPerPage);
  
  // Only redirect if there are tours and page is out of bounds
